...
<body class="bg-gradient-primary">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-2 col-md-9">
            ...
            <img width="200" src="img/nmb.png" alt="Logo">
        </div>
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="form-group">
                                            <input type="name" class="form-control form-control-user @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus
