       ...
       if (Auth::attempt(['email' => $request->email, 'password' => $request->password]))
        ...
        else
        {
           ...
           if ($user->login_tries >3)
           {
            ...
            $left=((3) -($user->login_tries));
            return redirect()->back()->with('message','You have made '.$user->login_tries .' attempt and you are left with ' .$left);           }
        }
    }
    else
    {
...
// the maximum number of attempts required is 3');
